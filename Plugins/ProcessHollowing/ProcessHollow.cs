...
namespace ProcessHollowing
{
    ...
    [ExportMetadata("name", "ProcessHollow")]
    public class ProcessHollow : IService
    {
        ...
        public ProcessHollow()
        {
            Injectionmetadata = new Metadata
            {
                ...
                Description = "Clean the specified process memory and write shellcode into that areas",
                References = new string[] {
                "https://github.com/ambray/ProcessHollowing",
                "https://github.com/surajpkhetani/ProcessHollowing",
                "https://github.com/passthehashbrowns/DInvokeProcessHollowing => DInvoke from SharpSploit",
                },
            ...
            {
                { ProcessKind.ProcessHollowing,new object[]{  } },
            });
    ...
    public class Help
    {
        public Help()
        {
             ...
             *
             byte[]  hollowProcess
            1. Start process in a  suspend state
            2. CreateSection  
            3. 将shellcode拷贝到 localsection
            4. ZwMapViewOfSection   Resume
    ...
    public sealed class Loader
    {
        ...
        public static void start(string name,byte[] shellcode)
        {
